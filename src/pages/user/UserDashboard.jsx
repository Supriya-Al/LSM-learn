        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-slate-300 mb-8 max-w-2xl leading-relaxed font-normal">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-white/10 text-white border border-white/20 font-medium hover:bg-white/15 transition-colors"
            >
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-3xl font-bold text-slate-900 leading-tight tracking-tight">{stat.value}</p>
                    </div>
            ...
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 font-normal">Your active courses</p>
                </div>
              </div>
              <Link
                to="/enrollments"
            ...
            <div className="space-y-4">
              {stats.recentEnrollments.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <Link
                    to="/courses"
                    className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-600 to-orange-500 text-white rounded-xl hover:from-orange-700 hover:to-orange-600 transition-all font-bold shadow-lg shadow-orange-500/30"
                  >
                ...
                stats.recentEnrollments.map((enrollment, idx) => {
                  ...
                  return (
                    <div
                      key={enrollment.id}
                      className="group relative border border-slate-200 rounded-lg overflow-hidden hover:border-orange-200 hover:shadow-md transition-all duration-200 bg-white"
                      onClick={() => navigate(`/courses/${enrollment.course_id}`)}
                    >
                      <div className="flex">
                        <div className="w-32 h-24 bg-slate-100 flex-shrink-0 relative overflow-hidden">
                          <img 
                            src={courseImage} 
                        ...
                        <div className="flex-1 p-4">
                          <div className="flex items-start justify-between mb-2">
                            <h3 className="font-semibold text-slate-900 text-sm group-hover:text-orange-600 transition-colors line-clamp-2 flex-1 pr-2">
            ...
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 font-normal">Latest updates</p>
                </div>
            ...
            <div className="space-y-3">
              ...
              {notifications.length === 0 && !notificationError ? (
                ...
                notifications.map((notification, idx) => (
                  <div
                    key={notification.id}
                    className={`group relative p-4 rounded-lg border-l-4 transition-all duration-200 hover:shadow-sm cursor-pointer ${
                      !notification.read 
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className={`mt-1 flex-shrink-0 w-2 h-2 rounded-full ${
                        !notification.read ? 'bg-orange-500' : 'bg-slate-300'
                      }`}></div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2 mb-1">
                          ...
                          {!notification.read && (
                            <span className="flex-shrink-0 px-2 py-0.5 bg-orange-600 text-white text-xs font-medium rounded-full">
                              New
                            </span>
                          )}
                        </div>
                        <p className="text-sm text-slate-600 leading-relaxed line-clamp-2 mb-2 font-normal">
